        ...
        <nav className="navbar-container">
            ...
            <div className="navbar-top-ml">
                <Link to="/" className="navbar-logo-link">
                    <img src={logo} alt="Logo La Anteojería" className="navbar-logo-img" />
                </Link>
                ...
                <div className="navbar-icons-ml">
                    ...
                    <button className="hamburger-btn-ml" onClick={() => setMenuOpen(!menuOpen)}>
            ...
            <form className="navbar-search-ml" onSubmit={manejarSubmit}>
                ...
                />
                <button type="submit" className="search-btn-ml">🔍</button>
            </form>
            ...
            <ul className={`navbar-categorias-ml ${menuOpen ? "open" : ""}`}>
                ...
                {isAuthenticated && isAdmin && <li><Link to="/admin">Admin Panel</Link></li>}
            </ul>
